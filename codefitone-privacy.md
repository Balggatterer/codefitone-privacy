...
#### Firebase
      * Beschreibung: Firebase ist eine umfassende Plattform von Google, die Entwicklern eine Vielzahl von Tools und Diensten zur Verfügung stellt, um mobile und Web-Anwendungen effizient zu erstellen, zu verbessern und zu skalieren
      * Verwendete Dienste:
...
Die Datenschutz-Grundverordnung (DSGVO) gilt grundsätzlich unmittelbar in allen Mitgliedstaaten der Europäischen Union. Das bedeutet, dass sie direkt anwendbar ist und keine Umsetzung in nationales Recht erfordert.
Jedoch räumt die DSGVO den Mitgliedstaaten in bestimmten Bereichen die Möglichkeit ein, abweichende oder ergänzende Regelungen zu erlassen. Diese nationalen Regelungen können strenger sein als die DSGVO, dürfen aber nicht hinter ihren Mindestschutzstandards zurückbleiben.
Wenn ein Mitgliedstaat von dieser Möglichkeit Gebrauch macht und abweichende Regelungen erlässt, dann kommen diese im jeweiligen Mitgliedstaat zur Anwendung. Das bedeutet, dass neben der DSGVO auch die nationalen Besonderheiten beachtet werden müssen.
